...
type Asset interface {
	...
	CacheAsset(ctx context.Context, assetCID string, sources []*types.DownloadSource) error //perm:write
	...
	QueryCachingAsset(ctx context.Context) (*types.CachingAsset, error) //perm:write
