...
func (sd sqlDB) SaveCacheResult(dInfo *DataInfo, cInfo *CacheInfo, updateBlock *BlockInfo, fid string, createBlocks []*BlockInfo) error {
	area := sd.ReplaceArea()
...
func (sd sqlDB) HaveBlocks(cacheID string, status int) (int, error) {
	area := sd.ReplaceArea()
