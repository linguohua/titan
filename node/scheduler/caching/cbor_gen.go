...
func (t *CarfileCacheInfo) MarshalCBOR(w io.Writer) error {
	if t == nil {
	...
	// t.State (cache.CarfileState) (string)
	...
	// t.CarfileHash (cache.CarfileHash) (string)
...
func (t *CarfileCacheInfo) UnmarshalCBOR(r io.Reader) (err error) {
	*t = CarfileCacheInfo{}
