...
func (state *CarfileInfo) toCarfileRecordInfo() *types.CarfileRecordInfo {
	return &types.CarfileRecordInfo{
		...
		SuccessedEdgeReplicas:      state.SuccessedEdgeReplicas,
		SuccessedCandidateReplicas: state.SuccessedCandidateReplicas,
...
func From(info *types.CarfileRecordInfo) *CarfileInfo {
	return &CarfileInfo{
		...
		SuccessedEdgeReplicas:      info.SuccessedEdgeReplicas,
		SuccessedCandidateReplicas: info.SuccessedCandidateReplicas,
