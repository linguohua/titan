...
// func addCandidateOfBandwidth100Mbps(manage *Manager, amount int) {
// 	for i := 0; i < amount; i++ {
...
// func addCandidateOfBandwidth500Mbps(manage *Manager, amount int) {
// 	for i := 0; i < amount; i++ {
// 		deviceID := uuid.NewString()
// 		manage.candidateNodeMap.Store(deviceID, &CandidateNode{
// 			Node: Node{
...
// func addEdgeOfBandwidth300Mbps(manage *Manager, amount int) {
// 	for i := 0; i < amount; i++ {
// 		deviceID := uuid.NewString()
...
// func addEdgeOfBandwidth100Mbps(manage *Manager, amount int) {
// 	for i := 0; i < amount; i++ {
// 		deviceID := uuid.NewString()
// 		manage.edgeNodeMap.Store(deviceID, &EdgeNode{
// 			Node: Node{
...
// func addEdgeOfBandwidth500Mbps(manage *Manager, amount int) {
// 	for i := 0; i < amount; i++ {
// 		deviceID := uuid.NewString()
// 		manage.edgeNodeMap.Store(deviceID, &EdgeNode{
// 			Node: Node{
